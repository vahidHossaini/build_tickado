...
cell2.className='abc';
   ...
   $('<span class="tabledit-span" >Click Me To Edit</span><input class="tabledit-input form-control input-sm" type="text" name="First" value="undefined" disabled="">').appendTo(cell1);
     ...
     $('<span class="tabledit-span" >_40mdo_3C/span><select class="tabledit-input form-control input-sm" name="Nickname"  disabled="" ><option value="1">_40mdo_3C/option><option value="2">_40fat_3C/option><option value="3">_40twitter_3C/option></select>').appendTo(cell3);
